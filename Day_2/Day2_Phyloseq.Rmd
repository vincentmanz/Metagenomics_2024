...
Use the custom function indices_normality() (defined in HELPER/indices_normality.R) plots the results of Shapiro test as well as Q-Qplots.
...
![shap1](https://github.com/vincentmanz/Metagenomics_2024/blob/main/Day_2/img/shap.png)
