...
vector_phyllum <- get_taxa_unique(merged_metagenomes, taxonomic.rank = "Phylum")
vector_filtered <- c(vector_phyllum[1:9], vector_phyllum[11:12], vector_phyllum[14:25], vector_phyllum[28], vector_phyllum[30:44])
merged_metagenomes <- subset_taxa(merged_metagenomes, Phylum %in% vector_filtered)
vector_phyllum <- get_taxa_unique(merged_metagenomes, taxonomic.rank = "Phylum")
